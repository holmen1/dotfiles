...
for p in $HOME/repos/dotfiles/install/common/git-prompt.sh /usr/share/git/completion/git-prompt.sh /etc/bash_completion.d/git-prompt.sh /mingw64/share/git/completion/git-prompt.sh; do
  [ -f "$p" ] && source "$p" && break
done
